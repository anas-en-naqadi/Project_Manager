...
import { register, resetValidationErros } from "../../features/UserSlice";
...
function SignUp() {
  ...
  const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
   e.preventDefault();
   if (validationErrors)
    dispatch(resetValidationErros());
     setLoading(false);
    const { payload } = await dispatch(register(user));
    if(payload) setLoading(true);
    if (payload && !payload?.company && token) return navigate("/company");
     else if (payload && payload?.company && token)
          ...
          <div className="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
            <div className="absolute inset-0">
              <img
                ...
                src="src/assets/images/register_back.jpg"
                alt=""
              />
            </div>

...
import { storeCompany } from "../features/CompanySlice";
...
function CompanyForm() {
  ...
  const validationErrors = useSelector((state: RootState)=>state.user.validationErrors);
  ...
  const companySetter = (e: React.ChangeEvent<
  ...
  >)=>{
    ...
    const handleCompany = async (event: FormEvent<HTMLFormElement>)=>{
      event.preventDefault();
      // Send company data to server here
      await dispatch(storeCompany(company));
      navigate("/dashboard");
    }
          ...
          <div className="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
            <div className="flex flex-col justify-between lg:py-5">
              ...
              <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:leading-tight lg:text-5xl">
                ...
                <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">
                  Create your company, manage projects, and handle your employees all in one place.
                </p>
            ...
            <div className="lg:pl-12">
              <div className="overflow-hidden bg-white rounded-md">
                ...
                <h3 className="text-3xl font-semibold text-black">Create Your Company</h3>
                  <p className="mt-4 text-base text-gray-600">
                    Fill out the details below to create your company profile.
                  </p>et sint.


                  <form onSubmit={handleCompany} className="mt-4">
